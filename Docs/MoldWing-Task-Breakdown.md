...
| 1.8 | 文件夹批量导入 | File→Import Folder | ⏳ |
...
M8 已完成基础功能（图层树面板、单OBJ显示、追加导入、异步加载）和多模型面拾取（方案B），下一步继续实现：
...
| ID | Task | 预计 |
|----|------|------|
| T8.6.3 | SelectionSystem 使用 CompositeId | 1.5h |

**验收标准**：框选时能同时选中多个模型的面

---

**文档版本**: 5.3 (Qt 方案 - M8 方案B：B1/B2 完成)
**最后更新**: 2025-12-31
