...
M8 已完成基础功能（图层树面板、单OBJ显示、追加导入、异步加载），下一步继续实现：
...
| ID | Task | 预计 |
|----|------|------|
| T8.2.1 | 添加显示/隐藏按钮（眼睛图标） | 0.5h |
| T8.2.2 | 实现模型显示/隐藏逻辑 | 1h |

**验收标准**：点击图层项旁边的眼睛图标，对应模型在 3D 视图中消失/出现

---

**文档版本**: 5.1 (Qt 方案 - M8 图层树与多模型管理 + 异步加载)
**最后更新**: 2025-12-30
