...
M3 刷选功能已完成，下一步开始实现 M4 套索选择功能：

### 🔥 优先：套索核心（S4.1）
| ID | Task | 预计 |
|----|------|------|
| T4.1.1 | 添加 SelectMode::Lasso 模式 | 0.5h |
| T4.1.2 | 使用 QPolygonF 记录鼠标轨迹 | 0.5h |
| T4.1.3 | 使用 LassoRenderer 绘制套索轨迹 | 1h |
| T4.1.4 | 实现多边形闭合检测 | 0.5h |

### 点在多边形内判断（S4.2）
| ID | Task | 预计 |
|----|------|------|
| T4.2.1 | 使用 QPolygonF::containsPoint() | 0.5h |
| T4.2.2 | 实现 endLassoSelect() | 1h |
| T4.2.3 | 优化：采样点简化 | 0.5h |

---

**文档版本**: 2.5 (Qt 方案 - M3 刷选完成)
**最后更新**: 2025-12-27
