...
M5 连通选择功能已完成，下一步开始实现 M6 纹理视图功能：

### 🔥 优先：UV窗口（S6.1）
| ID | Task | 预计 |
|----|------|------|
| T6.1.1 | 创建 UVViewWidget（QWidget） | 1h |
| T6.1.2 | 使用 QPainter 渲染纹理 | 1h |
| T6.1.3 | 实现 UV 视图缩放/平移 | 1h |
| T6.1.4 | 绘制 UV 网格线 | 1h |

### 选区同步（S6.2）
| ID | Task | 预计 |
|----|------|------|
| T6.2.1 | 计算选中面的 UV 范围 | 1h |
| T6.2.2 | 在 UV 视图中高亮选区 | 1h |
| T6.2.3 | 支持 UV 视图内选择面 | 1h |

---

**文档版本**: 2.8 (Qt 方案 - M5 连通选择完成)
**最后更新**: 2025-12-27
