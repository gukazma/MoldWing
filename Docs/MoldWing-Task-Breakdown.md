...
M4 套索选择功能已完成，下一步开始实现 M5 连通选择功能：
...
| ID | Task | 预计 |
|----|------|------|
| T5.2.1 | 添加 SelectMode::Link 模式 | 0.5h |
| T5.2.2 | 实现 selectLinked() BFS | 1h |
| T5.2.3 | 实现 selectByAngle() 角度限制 | 1h |
| T5.2.4 | 属性面板：角度阈值滑块 | 0.5h |

### 选择扩展/收缩（S5.3）
| ID | Task | 预计 |
|----|------|------|
| T5.3.1 | 实现 growSelection() | 0.5h |
| T5.3.2 | 实现 shrinkSelection() | 0.5h |

---

**文档版本**: 2.7 (Qt 方案 - M4 套索选择完成，鼠标/快捷键调整)
**最后更新**: 2025-12-27
