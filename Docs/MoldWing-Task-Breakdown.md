...
> - 支持 Shift 加选、Ctrl 减选、Shift+Ctrl 切换
...
M2 框选功能已完成，下一步开始实现 M3 刷选功能：

### 🔥 优先：刷选核心（S3.1）
| ID | Task | 预计 |
|----|------|------|
| T3.1.1 | 添加 SelectMode::Brush 模式 | 0.5h |
| T3.1.2 | 实现 brushRadius 属性 | 0.2h |
| T3.1.3 | 实现 updateBrushSelect() | 1h |
| T3.1.4 | 使用 QPainter 绘制刷选圆形光标 | 1h |
| T3.1.5 | 支持 [ ] 快捷键调整笔刷大小 | 0.5h |

### 刷选优化（S3.2）
| ID | Task | 预计 |
|----|------|------|
| T3.2.1 | 优化：仅检测笔刷范围内的面 | 1h |
| T3.2.2 | 支持持续拖拽选择 | 0.5h |
| T3.2.3 | 属性面板：笔刷大小滑块 (QSlider) | 0.5h |

---

**文档版本**: 2.4 (Qt 方案 - M2 框选完成)
**最后更新**: 2025-12-27
